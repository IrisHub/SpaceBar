...
export default function GLTFModel(props: CustomGLTF) {
  ...
  return (
    <> 
    { props.collision ? <primitive ref={collisionRef} position={props.position} object={copiedScene} dispose={null} /> :   <primitive position={props.position} object={copiedScene} dispose={null} />}
